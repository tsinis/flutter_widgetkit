...
struct DatabaseService {
    ...
    // Same method as in Dart class, reads a value from the database,
    ...
    // Same method as in Dart class, also opens a database from app group
